...
{{--<script src="gentelella/vendors/moment/min/moment.min.js"></script>--}}
{{--<script src="gentelella/vendors/fullcalendar/dist/fullcalendar.min.js"></script>--}}
...
{{--<script src="gentelella/vendors/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>--}}
{{--<script src="gentelella/vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js"></script>--}}
{{--<script src="gentelella/vendors/jquery-knob/dist/jquery.knob.min.js"></script>--}}
{{--<script src="gentelella/vendors/cropper/dist/cropper.min.js"></script>--}}
{{--<script  type="text/javascript">--}}
{{--    $(function () {--}}
{{--        $('#myDatepicker').datetimepicker();--}}
{{--    });--}}
...
{{--<script src="gentelella/vendors/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>--}}
...
{{--<script src="gentelella/production/js/chartjs/chart.min.js"></script>--}}
...
{{--<script src="gentelella/build/js/new-custom.js"></script>--}}
{{--<script src="gentelella/production/js/pace/pace.min.js"></script>--}}
{{--<script src="gentelella/vendors/jqvmap/dist/maps/jquery.vmap.usa.js"></script>--}}
